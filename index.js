...
class Store {
    ...
    update(userPath, fn, filter = (path, key) => true) {
        ...
        const oldValue = JSON.parse(JSON.stringify(view(lens, this.data)));
        let newValue = fn(view(lens, this.data));
        let differences = deepDiff(oldValue, newValue);
    ...
    diff(newValue, oldValue) {
        return deepDiff(newValue, oldValue);
    }
}
